...
document.getElementById("resultat").setAttribute("hidden","hidden");
	...
	//verifie prenom 
	if((document.getElementById("prenom").value.length<5)|| (document.getElementById("prenom").value.length>20))
	{
...
document.getElementById("resultat").setAttribute("hidden","hidden");
	...
	//verifie adress 
	if((document.getElementById("adress").value.length<5)|| (document.getElementById("adress").value.length>50))
	{
...
document.getElementById("resultat").setAttribute("hidden","hidden");
	...
	if((document.getElementById("email").value.length<5)|| (document.getElementById("email").value.length>30))
	{
